...
const Get_propmt = (content, title, _id, source, target_language) => `You are a professional translator specializing in ${target_language}. Your task is to translate the following content COMPLETELY into ${target_language}. The translation must be 100% in ${target_language} with NO English words remaining except for the specific exceptions listed below.
