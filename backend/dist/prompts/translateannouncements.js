...
exports.Get_Prompt = void 0;
const Get_Prompt = (announcements, target_language) => {
    const formatted_announcements = announcements.map(announcement => `title: ${announcement.title}\nsource: ${announcement.source}\ntype: ${announcement.type}\n_id: ${announcement._id}\ncontent: ${announcement.summary}`);
